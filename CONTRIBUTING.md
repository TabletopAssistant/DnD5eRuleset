# Contributing to DnD5eRuleset

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to DnD5eRuleset.
These are just guidelines, not rules, use your best judgment and feel free to
propose changes to this document in a pull request.

This project adheres to the [Open Code of Conduct][code-of-conduct]. By participating, you are expected to honor this code.
[code-of-conduct]: http://todogroup.org/opencodeofconduct/#DnD5eRuleset/opensource@brentleyjones.com
...
* Consider starting the commit message with an applicable emoji:
    ...
    * :iphone: `:iphone:` when fixing something on iOS
    * :watch: `:watch:` when fixing something on watchOS
